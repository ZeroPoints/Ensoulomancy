...
public class ObjSeeds extends Item implements IHasModel, IPlantable { 

	public ObjSeeds() {
		super();
		
		setUnlocalizedName("obj_seeds");
		setRegistryName("obj_seeds");
	...
	public void registerModels() {
		Main.proxy.registerItemRenderer(this, 0, "obj_seeds");
	}
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if(facing == EnumFacing.UP && player.canPlayerEdit(pos.offset(facing), facing, stack) && 
			...
			worldIn.setBlockState(pos.up(), ModBlocks.OBJ_CROP.getDefaultState());
			stack.shrink(1);
    ...
    public net.minecraft.block.state.IBlockState getPlant(net.minecraft.world.IBlockAccess world, BlockPos pos) {
        return ModBlocks.OBJ_CROP.getDefaultState();
    }
