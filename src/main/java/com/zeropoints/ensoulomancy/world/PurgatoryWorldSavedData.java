...
public class PurgatoryWorldSavedData extends WorldSavedData {
	...
	public static PurgatoryWorldSavedData GetExisting(World world) {
		  ...
		  PurgatoryWorldSavedData instance = (PurgatoryWorldSavedData) storage.getOrLoadData(PurgatoryWorldSavedData.class, Name);
	...
	/*
	 * Save the structure data. As its a IWorldGenerated object the purgatorychunkgenerator doesnt know about it
	 * 
	 */
	...
	public void readFromNBT(NBTTagCompound nbt) {
	    ...
	    for(int i = 0; i < tagList.tagCount(); i++) {
	    	...
	    	spiritTempleLocations.put(metaData.getLong("metadata_pos"), new StructureBoundingBox(metaData.getIntArray("metadata_box")));
	    }
	...
	public NBTTagCompound writeToNBT(NBTTagCompound compound) {
	    ...
	    while (it.hasNext()) {
        	...
        	metaData.setIntArray("metadata_box",  ((StructureBoundingBox)pair.getValue()).toNBTTagIntArray().getIntArray());
