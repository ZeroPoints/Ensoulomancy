	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator,
		...
		if (canSpawnStructureAtCoords(random, world, chunkX, chunkZ)) {
			...
			final Template template = world.getSaveHandler().getStructureTemplateManager()
					.getTemplate(world.getMinecraftServer(), SPIRIT_TEMPLE);
			...
			StructureBoundingBox boundingBox = new StructureBoundingBox(basePos.getX(), basePos.getY(), basePos.getZ(),
					oppCorner.getX(), oppCorner.getY(), oppCorner.getZ());

			Main.log("SpiritTemple Generated: " + basePos.toString() + ", rotation: " + rot.toString() + ", oppCorner: "
					+ oppCorner.toString() + ", structSize: " + structureSize.toString() + ", boundBox: "
					+ boundingBox);
