...
public class RiverStyxBiome extends Biome implements ICustomBiome {
	 ...
	 */
	public RiverStyxBiome() {
		super(new Biome.BiomeProperties("RiverStyxBiome").setBaseHeight(2.55F).setHeightVariation(0.4F));
		
		//May aswell register it i guess
		this.setRegistryName(Main.MOD_ID, "riverystyx");
		
		//Set some default blocks for this biome
		this.topBlock = Blocks.WOOL.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.BLUE);
		this.fillerBlock = Blocks.WOOL.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.BLUE);
