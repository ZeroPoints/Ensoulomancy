...
public class LayerHuskSpiderLegs<T extends EntityHusk> implements LayerRenderer<T> {
    ...
    public LayerHuskSpiderLegs(RenderHusk renderer) {
	...
	public void doRenderLayer(T entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
		...
		if (entity.options == null || !entity.options.extraOptions.contains("spiderLegs")) {
			return;
		}
